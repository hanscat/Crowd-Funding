...
class Report(models.Model):
    ...
    projects = models.CharField(max_length=200, default="")
    projects2 = models.CharField(max_length=200, default="")
    projects3 = models.CharField(max_length=200, default="")
    projects4 = models.CharField(max_length=200, default="")
    projects5 = models.CharField(max_length=200, default="")
